...
namespace coreef.Controllers
{
    public class PhonesController : Controller
    {
        ...
        public PhonesController(coreefContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Remark")] Phone phone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Remark")] Phone phone)
        {
            if (id != phone.Id)
            {
                return NotFound();
